      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            <Link
              href="/"
              className="text-gray-700 hover:text-[var(--primary)] font-medium text-sm"
            >
              HOME
            </Link>
            <Link
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden mt-4 space-y-3 pb-4">
            <Link
              href="/"
              className="block text-gray-700 hover:text-[var(--primary)] text-sm"
            >
              HOME
            </Link>
            <Link
            ...
            <button className="w-full px-5 py-2 bg-[var(--primary)] hover:bg-[var(--primary)]/90 text-white rounded-md text-sm">
              LOGIN
            </button>
          </div>
        )}
