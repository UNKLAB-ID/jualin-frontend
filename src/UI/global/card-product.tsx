    ...
    return (
        <div className="bg-white rounded-lg sm:rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-300 w-full">
            ...
            <div className="relative overflow-hidden">
                ...
                >
                    {isFavorite ? (
                        <FavoriteIcon className="text-red-500" sx={{ fontSize: { xs: 18, sm: 24 } }} />
                    ) : (
                        <FavoriteBorderIcon className="text-gray-600" sx={{ fontSize: { xs: 18, sm: 24 } }} />
                    )}
                </button>
                <div
            ...
            <div className="p-2 sm:p-4">
                ...
                <div className="hidden sm:flex items-center gap-2 text-sm text-gray-500 mb-3">
                    <span className="bg-gray-100 px-2 py-1 rounded-md text-xs font-medium">{category}</span>
                    <span>•</span>
                    <span>{location}</span>
                </div>
                ...
                <div className="mb-2 sm:mb-3">
                    <p className="text-sm sm:text-2xl font-bold text-[var(--primary)]">{price}</p>
                    {originalPrice && (
